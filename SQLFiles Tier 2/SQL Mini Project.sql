...
JOIN Bookings AS b
	ON m.memid = b.memid
WHERE facid IN (0,1) AND m.memid > 0
ORDER BY Member;
...
JOIN Members AS m 
		ON b.memid = m.memid
WHERE  b.starttime BETWEEN '2012-09-14 00:00:00' AND '2012-09-14 23:30:00' 
AND (
...
FROM (
    ...
    FROM Bookings AS b
		...
		JOIN Members AS m 
			ON b.memid = m.memid
		WHERE  b.starttime
    		BETWEEN '2012-09-14 00:00:00' AND '2012-09-14 23:30:00' 
) subquery
WHERE cost > 30
ORDER BY cost DESC;